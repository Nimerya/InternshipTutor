...
--
-- Host: localhost:8889
-- Creato il: Set 11, 2018 alle 10:32
...
(25, 'Company1', 'Company1_Address', 'Company1_FiscalCode', 'Company1_VatNumber', 'Company1_Attorney', 'Company1_Jurisdiction', 1, 'agreement_Company1_5498163889156602226.pdf'),
(26, 'Company2', 'Company2_Address', 'Company2_FiscalCode', 'Company2_VatNumber', 'Company2_Attorney', 'Company2_Jurisdiction', 1, 'agreement_Company2_7729082749576832384.pdf'),
(27, 'Company3', 'Company3_Address', 'Company3_FiscalCode', 'Company3_VatNumber', 'Company3_Attorney', 'Company3_Jurisdiction', 1, 'agreement_Company3_1853351229129954551.pdf'),
(28, 'Company4', 'Company4_Address', 'Company4_FiscalCode', 'Company4_VatNumber', 'Company4_Attorney', 'Company4_Jurisdiction', 1, 'agreement_Company4_4586025141159054322.pdf'),
(29, 'Company5', 'Company5_Address', 'Company5_FiscalCode', 'Company5_VatNumber', 'Company5_Attorney', 'Company5_Jurisdiction', 1, 'agreement_Company5_942588538946894334.pdf'),
(30, 'Company6', 'Company6_Address', 'Company6_FiscalCode', 'Company6_VatNumber', 'Company6_Attorney', 'Company6_Jurisdiction', 1, 'agreement_Company6_5822055266651478958.pdf'),
(31, 'Company7', 'Company7_Address', 'Company7_FiscalCode', 'Company7_VatNumber', 'Company7_Attorney', 'Company7_Jurisdiction', 1, 'agreement_Company7_3769454826765263223.pdf'),
(32, 'Company8', 'Company8_Address', 'Company8_FiscalCode', 'Company8_VatNumber', 'Company8_Attorney', 'Company8_Jurisdiction', 1, 'agreement_Company8_2679411773798981519.pdf'),
(33, 'Company9', 'Company9_Address', 'Company9_FiscalCode', 'Company9_VatNumber', 'Company9_Attorney', 'Company9_Jurisdiction', 1, 'agreement_Company9_2135366800277542262.pdf'),
(34, 'Company10', 'Company10_Address', 'Company10_FiscalCode', 'Company10_VatNumber', 'Company10_Attorney', 'Company10_Jurisdiction', 1, 'agreement_Company10_1143827707623801813.pdf'),
(42, 'Company11', 'Company11_Address', 'Company11_FiscalCode', 'Company11_VatNumber', 'Company11_Attorney', 'Company11_Jurisdiction', 1, 'agreement_Company11_7423621856523385872.pdf');
...
--
-- Dump dei dati per la tabella `internship`
--
...
(1, 'jojojoijoijio', 'ojiojoijiojoijoij', 'oi', 'joijioj', 'iojoi', 0, 'joi', 12, 'oij', 'ioj', 'ioj', 'oij', 0, 'oi', 'jio', 'jio', 25, 1),
(2, 'kjhiuhihiu', 'uihuihiuhiu', 'hiuh', 'iuh', 'iuh', 0, 'iuh', 12, 'jhbhjbhjbhjb', 'jhbj', 'hbhjbjhbhjbhj', 'bjhbjhb', 0, 'hjbhj', 'bk', 'bjhk', 42, 1),
(3, 'Lorem ipsum dolor sit amet', 'Via Giovanni Di Vincenzo 16/B', 'L\'Aquila', 'AQ', 'Italy', 1, 'MON - WED - THU, from 9:30 AM to 4:30 PM', 150, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec tincidunt arcu. Curabitur pellentesque vel leo et aliquam.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec tincidunt arcu. Curabitur pellentesque vel leo et aliquam.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec tincidunt arcu. Curabitur pellentesque vel leo et aliquam.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec tincidunt arcu. Curabitur pellentesque vel leo et aliquam.', 'Donec quis dapibus nulla, commodo ullamcorper dui. Mauris condimentum lacinia augue nec volutpat. Aenean molestie laoreet sagittis.', 'Donec quis dapibus nulla, commodo ullamcorper dui. Mauris condimentum lacinia augue nec volutpat. Aenean molestie laoreet sagittis.Donec quis dapibus nulla, commodo ullamcorper dui. Mauris condimentum lacinia augue nec volutpat. Aenean molestie laoreet sagittis.', 1, 'Suspendisse fringilla nunc non commodo fringilla. Nam porttitor risus vitae molestie imperdiet. In quis lorem auctor, hendrerit sapien a, feugiat magna. ', 'Suspendisse fringilla nunc non commodo fringilla. Nam porttitor risus vitae molestie imperdiet. In quis lorem auctor, hendrerit sapien a, feugiat magna. Suspendisse fringilla nunc non commodo fringilla. Nam porttitor risus vitae molestie imperdiet. In quis lorem auctor, hendrerit sapien a, feugiat magna. Suspendisse fringilla nunc non commodo fringilla. Nam porttitor risus vitae molestie imperdiet. In quis lorem auctor, hendrerit sapien a, feugiat magna. ', 'Nullam dignissim mauris a nibh condimentum, vitae tincidunt diam mollis. Nunc pulvinar massa mi, vitae pellentesque ante aliquam in.Nullam dignissim mauris a nibh condimentum, vitae tincidunt diam mollis. Nunc pulvinar massa mi, vitae pellentesque ante aliquam in.', 42, 1);
...
--
-- Dump dei dati per la tabella `student_internship`
--
...
(3, 19, 3, 20, 6, NULL, 0, 0, 0, NULL, NULL);
...
--
-- AUTO_INCREMENT per la tabella `student_internship`
--
ALTER TABLE `student_internship`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
-- Limiti per la tabella `internship`
--
ALTER TABLE `internship`
...
--
-- Limiti per la tabella `professor`
--
ALTER TABLE `professor`
...
--
-- Limiti per la tabella `student_internship`
--
ALTER TABLE `student_internship`
